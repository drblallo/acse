...
"eorl"|"EORL"      { yylval.opcode = EORL_OP; return OPCODE3; }
"andb"|"ANDB"      { yylval.opcode = ANDB_OP; return OPCODE3; }
"orb"|"ORB"        { yylval.opcode = ORB_OP; return OPCODE3; }
"eorb"|"EORB"      { yylval.opcode = EORB_OP; return OPCODE3; }
...
"eorli"|"EORLI"    { yylval.opcode = EORLI_OP; return OPCODE2; }
"andbi"|"ANDBI"    { yylval.opcode = ANDBI_OP; return OPCODE2; }
"orbi"|"ORBI"      { yylval.opcode = ORBI_OP; return OPCODE2; }
"eorbi"|"EORBI"    { yylval.opcode = EORBI_OP; return OPCODE2; }
